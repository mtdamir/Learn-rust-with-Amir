...
//impl Trait is similar to generics. 
//You remember that generics use a type T (or any other name) which then gets decided when the program compiles. 
//First let's look at a concrete type:
